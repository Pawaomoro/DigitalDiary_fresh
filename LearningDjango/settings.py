...
DATABASES = {
    'default': {
        ...
        'NAME': 'DigitalDairy',      # Database name
        'USER': 'root',              # Default XAMPP username
        'PASSWORD': '',              # Default XAMPP password (empty)
        'HOST': 'localhost',         # or '127.0.0.1'
        'PORT': '3306',              # Must be a string, not integer
        'OPTIONS': {
...
# DEFAULT_FROM_EMAIL = 'Digicow <noreply@digicow.app>'

# # SMS settings (for Africa's Talking or similar service)
# SMS_API_URL = 'https://api.africastalking.com/version1/messaging'
# SMS_USERNAME = 'your_username'
# SMS_API_KEY = 'your_api_key'
# SMS_SENDER_ID = 'DIGICOW'

# # Site URL for building absolute URLs
# SITE_URL = 'https://yourdomain.com'
# For storing fodder images
import os
MEDIA_URL = '/media/'
